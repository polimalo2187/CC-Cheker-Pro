...
# -------------------------------
stripe.api_key = os.getenv("STRIPE_API_KEY")  # Tu API Key de Stripe desde variable de entorno

def validate_card(card: str) -> str:
    """
    Valida una tarjeta usando Stripe.
    
    card = "4242424242424242|12|2026|123"  # formato: numero|mes|año|cvc
    Devuelve:
        - "Life"  -> Tarjeta completamente válida
